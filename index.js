...
/*Görev 1: macSkoru()
  ...
  skor1 de closure metodu kullanıldığı için skor arttırılması sadece skorGuncelle() fonksiyonu içerisinde müdahale edilebilir. Skor2 deki gibi dış faktörlerden etkilenmez.
...
function takimSkoru() {
  let sonuc = Math.round(Math.random() * 100);
  while (sonuc >= 10 && sonuc <= 25) {
    return sonuc;
  }
  return takimSkoru();
}
